...
ESP32-S3, Kamera, VL53L5CX, Baterai]
    ANALISIS --> KEBUTUHAN_SW[Kebutuhan Software:
...
Diagram Blok & Wiring Skematik]
    PERANCANGAN --> DESAIN_MEKANIK[Desain Mekanik:
Casing Kacamata & Tata Letak]
    PERANCANGAN --> DESAIN_LOGIKA[Desain Logika:
...
YOLOv11 Nano Custom Dataset]
    IMPLEMENTASI --> RAKIT[Perakitan Hardware & Coding Android]
...
3. Usability User]
    ...
    class IDENTIFIKASI,STUDI_LIT,PENGUMPULAN_DATA,ANALISIS,ANALISIS_HASIL,KESIMPULAN research;
    class KEBUTUHAN_HW,KEBUTUHAN_SW,PERANCANGAN,DESAIN_ARSITEKTUR,DESAIN_MEKANIK,DESAIN_LOGIKA design;
    class IMPLEMENTASI,TRAINING,RAKIT,DEBUG impl;
    class PENGUJIAN decision;
```
